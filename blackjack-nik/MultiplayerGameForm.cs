...
namespace blackjack_nik
{
    public partial class MultiplayerGameForm : Form
    {
        ...
        public MultiplayerGameForm(ServerInfo serverInfo, GameOptions options)
        {
        ...
        {
            this.Text = $"Multiplayer: {serverInfo.Name} ({serverInfo.Region})";
            
            // For now, we initialize a local game to show the UI. 
            // In the future, this will be driven by network events.
            ...
            // Add a visual indicator that this is multiplayer
            lblMessage.Text = $"Connected to {serverInfo.Name}. Waiting for game...";
        ...
        private void UpdateUI(bool initial = false)
        {
            ...
            if (!initial) // Don't overwrite the "Connected" message on initial load
            {
